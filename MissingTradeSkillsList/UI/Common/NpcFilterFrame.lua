...
MTSLUI_NPC_FILTER_FRAME = {
    ...
    BuildRanks = function(self)
        self.ranks = {
            ...
            {
                ["name"] = MTSLUI_LOCALES_PROFESSION_RANKS[MTSLUI_CURRENT_LANGUAGE]["Apprentice"],
                ["id"] = 1,
            },
            {
                ["name"] = MTSLUI_LOCALES_PROFESSION_RANKS[MTSLUI_CURRENT_LANGUAGE]["Journeyman"],
                ["id"] = 2,
            },
            {
                ["name"] = MTSLUI_LOCALES_PROFESSION_RANKS[MTSLUI_CURRENT_LANGUAGE]["Expert"],
                ["id"] = 3,
            },
            {
                ["name"] = MTSLUI_LOCALES_PROFESSION_RANKS[MTSLUI_CURRENT_LANGUAGE]["Artisan"],
                ["id"] = 4,
            },
        }
        self.current_rank = 0
    ...
    BuildProfessions = function(self)
        ...
        for _, v in pairs(MTSL_NAME_PROFESSIONS) do
           local new_profession = {
                ["name"] = MTSLUI_LOCALES_PROFESSIONS[MTSLUI_CURRENT_LANGUAGE][v],
                ["id"] = v,
            }
