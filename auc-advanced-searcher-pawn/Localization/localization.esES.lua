...
Localization.RegisterAddonStrings("esES", "Localization",
  {
    -- Locales
    enUS      = "Inglés";
    enGB      = "Inglés";
...
Localization.RegisterAddonStrings("esES", "Auc-Searcher-Pawn",
  {
    -- Config
    ...
    SCALE_SELECT_TIP  = "La escala de Pawn que se utiliza para determinar el valor del elemento";
