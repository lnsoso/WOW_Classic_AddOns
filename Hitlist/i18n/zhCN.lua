...
L["SETTINGS_TEST_NEARBY"] = "附近有敌意的玩家";
L["SETTINGS_TEST_KILLER_LIST"] = "最近袭击者";
...
L["UI_TT_PLAYER_ON_LIST"] = "玩家已经在名单中";
L["UI_TT_YOU"] = "you";
L["UI_TT_ADDED_BY"] = "(Added by %s %s ago)";

L["NBL_TITLE"] = "附近有敌意的玩家";
L["UI_NBL_TT_TARGET_WL"] = "左键选为目标, (shift-)右键隐藏.";