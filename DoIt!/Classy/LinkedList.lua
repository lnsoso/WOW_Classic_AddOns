...
LinkedList = {
    LinkedListNode = {
        new = function (value)
            return addon.createInstance(LinkedList.LinkedListNode, function (self)
                self:set(value);
            end);
        end,
    ...
    new = function (constructor)
        return addon.createInstance(LinkedList, constructor);
    end,
    constructor = function (self)
        self._firstNode = nil;
        self._lastRef = nil;
    ...
    insertAfter = function (self, refNode, value)
        local node = LinkedList.LinkedListNode.new(value);
        if (not refNode) then
