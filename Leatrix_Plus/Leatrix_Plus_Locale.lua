...
L["Class Colored Frames"] = "Цветные рамки класса"
...
L["Halls of Origination"] = "Залы происхождения"
...
L["If checked, class colors will be used in the chat frame."] = "Если флажок установлен, то цвета классов будут использоваться в чате."
...
L["If checked, the 'Display only character achievements to others' setting in the game options panel ('Social' menu) will be permanently checked and locked."] = "Если флажок установлен, то параметр 'Позволить другим просматривать только достижения персонажа' будет постоянно включен и заблокирован."
...
L["If checked, the level-up display will not be shown.|n|nThe level-up display shows encounter objectives, level-ups, pet battle rewards, etc."] = "Если флажок установлен, то окно увеличения уровня не будет отображаться.|n|nЭто окно обычно отображает цели подземелья, повышение уровня, награды за битву питомцев и др."
...
L["If checked, the per unit vendor price will be shown in item tooltips."] = "Если флажок установлен, то во всплывающих подсказках предметов будет отображаться их цена за единицу у торговца."
...
L["If checked, the shaman class color will be changed from pink to blue."] = "Если флажок установлен, цвет класса шамана будет изменен с розового на синий."
...
L["Invite From Whispers"] = "Пригласить от шепота"
...
L["Make shaman blue"] = "Сделать шамана синим"
...
L["Battle"] = "Batalla"
L["Battle of Angrathar the Wrathgate"] = "Batalla de Angrathar la Puerta de Cólera"
...
L["Cape of Stranglethorn"] = "Cabo de Tuercespina"
...
L["Class Colored Frames"] = "Marcos de Clase Coloreado"
...
L["click here to shuffle music"] = "haga clic para barajar música"
...
L["D"] = "C"
L["Dalaran"] = "Dalaran"
L["Darken the frame background"] = "Oscurecer el fondo del marco"
...
L["Enter"] = "Entrar"
L["enter music or movie name"] = "entrar música o nombre de película"
...
L["Error Text"] = "Texto de error"
L["Events"] = "Eventos"
L["Eversong Woods"] = "Bosque Canción Eterna"
L["Extras"] = "Excesos"
L["Eye of the Storm"] = "Ojo de la Tormenta"
L["Fall of the Lich King"] = "La Caída del Rey Exánime"
L["False"] = "Falso"
...
L["Forge of Souls"] = "La Forja de Almas"
L["Frames"] = "Marcos"
...
L["Hide crafted names"] = "Ocultar nombres de fabricación"
L["Hide error messages"] = "Mensajes de error"
L["Hide gryphons"] = "Grifos"
L["Hide level-up display"] = "Ocultar visualización de subir nivel"
...
L["If checked, crafted items will no longer show the name of the crafter."] = "Si está marcado, los objetos creados ya no mostrarán el nombre del artesano."
...
L["If checked, the boss banner will not be shown.|n|nThe boss banner appears when a boss is defeated.  It shows the name of the boss and the loot that was distributed."] = "Si está marcado, no se mostrará la bandera del jefe.|n|nLa bandera del jefe aparece cuando un jefe es derrotado. Muestra el nombre del jefe y el botín que se distribuyó."
...
L["If checked, the clock will be hidden."] = "Si está marcado, el reloj estará oculto."
...
L["If checked, the 'Display only character achievements to others' setting in the game options panel ('Social' menu) will be permanently checked and locked."] = "Si está marcado, la configuración 'Mostrar solo logros de personajes a otros' en el panel de opciones del juego (menú 'Social') se verificará y bloqueará permanentemente."
...
L["If checked, the game world will be resized to fit between the top and bottom borders.|n|nNote that if you enable this setting, the transparency slider will no longer affect the top and bottom borders."] = "Si está marcado, el mundo del juego cambiará de tamaño para ajustarse entre los bordes superior e inferior.|n|nTenga en cuenta que si habilita esta configuración, el control deslizante de transparencia ya no afectará los bordes superior e inferior."
L["If checked, the gossip window will not be shown when you talk to an active garrison bodyguard.|n|nYou can hold the shift key down when you talk to a bodyguard to override this setting."] = "Si está marcado, no se mostrará la ventana diálogo cuando se habla con un guardia guarnición activo.|n|nPuede mantener presionada la tecla shift cuando hable con un guardaespaldas para anular esta configuración."
...
L["If checked, the level-up display will not be shown.|n|nThe level-up display shows encounter objectives, level-ups, pet battle rewards, etc."] = "Si está marcado, no se mostrará la pantalla de subir nivel.|n|nLa pantalla de subir nivel muestra objetivos de encuentro, niveles, recompensas de batalla de mascotas, etc."
...
L["If checked, the per unit vendor price will be shown in item tooltips."] = "Si está marcado, el precio de venta por unidad se mostrará en el tooltip del objeto."
...
L["If checked, the shaman class color will be changed from pink to blue."] = "Si está marcado, el color de la clase de chamán cambiará de rosa a azul."
...
L["Make shaman blue"] = "Colorear azul el chamán"
...
L["Merge the tracking and calendar buttons"] = "Mezclar los botones de rastreo y el calendario"
...
L["Nude"] = "Nudo"
L["Obsidian Sanctum"] = "Sagrario Obsidiana"
...
L["Player"] = "Jugador"
L["Player Chain"] = "Cadena de jugador"
L["Portal"] = "Portal"
L["Power"] = "Poder"
...
L["Repair using guild funds if available"] = "Repara usando fondos de la hermandad si están disponibles"
L["Repaired for"] = "Reparado por"
L["Reposition the tooltip"] = "Reposicionar el tooltip"
L["Requires UI reload."] = "Requiere recargar la IU."
L["Requires you to be interacting with Larana Drome.  She can be found at Scribes' Sacellum, Dalaran, Northrend."] = "Requiere que interactúes con Larana Dromo. Se encuentra en Dalaran en la tienda de inscripción."
L["Reset"] = "Restablecer"
...
L["Resize the game world"] = "Redimensionar el mundo del juego"
...
L["Ruby Sanctum"] = "El Sagrario Rubí"
...
L["Shadowmoon Valley"] = "Valle de Sombraluna"
...
L["Show pet save button"] = "Botón de guardar mascota"
...
L["Stop"] = "Parar"
L["Storm Peaks"] = "Las Cumbres Tormentosas"
...
L["Use Leatrix Plus to move that frame."] = "Usa Leatrix Plus para mover ese marco."
L["Use Leatrix Plus to reset that frame."] = "Usa Leatrix Plus para restablecer ese marco."
